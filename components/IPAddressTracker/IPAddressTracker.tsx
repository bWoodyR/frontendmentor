...
const IPAddressTracker = async () => {
  ...
  const userIpLocation = userIPData.ipData?.region || "Bratislava";
  ...
  return (
    <section className="relative flex flex-col  min-h-screen font-rubik">
      ...
      <iframe src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_MAP_API_KEY}&q=${userIpLocation}&zoom=16&maptype=satellite`} className="w-full min-h-max flex-1"></iframe>
